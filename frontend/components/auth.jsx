...
const Auth = () => {
  ...
  return (
    <>
      <main className="fixed font-primary top-0 w-full h-full bg-black/70 flex items-center justify-center">
        <div className="bg-white flex flex-col items-center justify-center gap-4  w-[400px] min-h-[500px] rounded-lg p-2">
          ...
          <div className="flex flex-col gap-8">
            ...
            <button className="bg-black mx-auto w-full h-12 rounded-[8px] text-white">
              Login
            </button>
          </div>
        </div>
